...
public class Array {
	...
	public static void main(String[] args) {
		...
		//pixels of a image, modify each pixel in 2D matrix. RBG color is value of int
		/*************************************************************/
		...
		//scores.length --> no. of rows
		//scores[0].length --> no. of columns
		int[] scoreVariable = scores[0];
	}
